...
class Solution {
    ...
    public String reverseWords(String s) {
        // Code here
     s=s.trim(); // trim the leading spaces 
     String[] reverse=s.split("\\s+");  // convert the string into string array
     String net="";
        for(int i=reverse.length-1;i>=0;i--)
        {
            net=net+reverse[i]; //String array to string
            
            if (i > 0) 
            {
                net += " ";  // give spaces after word
            }
